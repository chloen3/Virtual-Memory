...
void compute_stats() {
    ...
    double write_back_time = stats.writebacks * DISK_PAGE_WRITE_TIME;

    double total_time = page_fault_time + write_back_time + memory_access_time;

    stats.amat = total_time / stats.accesses;
